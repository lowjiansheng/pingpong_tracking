...
%   Assumes clean data: no NaNs, no weird completely out of place markers
...
cam1_img_pts_dir_vectors = cam1.img_pt2dir_vec(cam1_img_pts);
cam2_img_pts_dir_vectors = cam2.img_pt2dir_vec(cam2_img_pts);
cam3_img_pts_dir_vectors = cam3.img_pt2dir_vec(cam3_img_pts);
